            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="pt-4 grid grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
                  <div className="text-2xl font-extrabold text-[#0B2238]">20+</div>
                  <div className="text-xs font-semibold text-slate-500 uppercase mt-0.5">Years Experience</div>
                </div>
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
                  <div className="text-2xl font-extrabold text-[#0B2238]">$10M+</div>
                  <div className="text-xs font-semibold text-slate-500 uppercase mt-0.5">Estate Assets Protected</div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-[#f8fafc] border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl font-extrabold text-[#0B2238]">Why Clients Choose Our Firm</h2>
            <p className="text-slate-600 text-sm mt-2">Unmatched commitment during life’s most difficult transitions.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-white border border-slate-200 shadow-xs">
              ...
              <h3 className="text-xl font-bold text-[#0B2238] mb-3">Trial-Tested Litigators</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                We prepare every estate dispute with rigorous courtroom trial discipline, giving our clients immense leverage in settlement discussions.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-white border border-slate-200 shadow-xs">
              ...
              <h3 className="text-xl font-bold text-[#0B2238] mb-3">Compassionate Mediation</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Where possible, we employ creative dispute mediation techniques to resolve sibling and family disputes without irreparable harm to relationships.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-white border border-slate-200 shadow-xs">
              ...
              <h3 className="text-xl font-bold text-[#0B2238] mb-3">Absolute Confidentiality</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Family inheritance matters demand privacy. We maintain stringent privacy protocols and discreet legal strategies.
              </p>
            </div>
          </div>
