        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed mb-8">
              At Richard Weaver P.C., our lawyers provide direct, partner-level advocacy with zero hand-offs. Connect directly with any member of our inheritance and estate legal team.
            </p>
          </div>
        </div>
      </section>
